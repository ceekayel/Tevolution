...
if( !class_exists('WPUpdatesTevolutionUpdater') ) {
    class WPUpdatesTevolutionUpdater {
		...
		if ( is_network_admin() || !is_multisite() ) {			
			add_action('after_plugin_row_'.TEVOLUTION_SLUG, array(&$this, 'tevolution_templatic_plugin_row'),10,3 );	  
		}
    	}
	 ...
	 */
	function tevolution_templatic_plugin_row($plugin_file, $plugin_data,$status)
	{
